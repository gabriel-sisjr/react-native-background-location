...
See the [Geofencing Guide](../guides/geofencing) for full documentation.
...
For projects upgrading past v0.12.0, continue with the [v0.14.0 migration guide](./v0-14-0).
