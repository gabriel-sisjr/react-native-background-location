...
class ActivityRecognitionProvider : ActivityProvider {
  ...
  override fun requestActivityTransitionUpdates(
    ...
    activityRecognitionClient?.requestActivityTransitionUpdates(request, pendingIntent)
      ?.addOnSuccessListener {
        android.util.Log.d("ActivityRecognitionProvider", "Successfully registered for activity transition updates")
      }
      ?.addOnFailureListener { e ->
        android.util.Log.e("ActivityRecognitionProvider", "Failed to register for activity transition updates", e)
      }
  }
  ...
  override fun removeActivityTransitionUpdates(pendingIntent: PendingIntent) {
    activityRecognitionClient?.removeActivityTransitionUpdates(pendingIntent)
      ?.addOnSuccessListener {
        android.util.Log.d("ActivityRecognitionProvider", "Successfully removed activity transition updates")
      }
      ?.addOnFailureListener { e ->
        android.util.Log.e("ActivityRecognitionProvider", "Failed to remove activity transition updates", e)
      }
  }
