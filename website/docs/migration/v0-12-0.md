---
sidebar_position: 3
title: "Migration: v0.10.x to v0.12.0"
description: Migrate from v0.10.x to v0.12.0 with granular permission state, unified NotificationOptions, and iOS notification permission changes.
keywords:
  - migration
  - v0.12.0
  - permissions
...
See the [Geofencing Guide](../guides/geofencing.md) for full documentation.
...
For projects upgrading past v0.12.0, continue with the [v0.14.0 migration guide](./v0-14-0.md).
