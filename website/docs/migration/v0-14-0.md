...
The migration is intentionally small in scope. If you are upgrading from an older version, go through [v0.12.0 migration](./v0-12-0) first, then apply this guide.
